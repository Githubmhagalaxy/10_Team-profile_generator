...
const generateHtml = data => {
    ...
    let tmp = '';
    data.managers.forEach(obj => {
        tmp += `
<li>
    <div class="head">
        <div class="name">${obj.getName()}</div>
        <div class="role">
            <span class="icon">
            ...
            <span class="text">${obj.getRole()}</span> <!-- Manager -->
        </div>
    </div>
    <div class="body">
        <ul>
...
<li>
    <div class="head">
        ...
        <div class="role">
            ...
            <span class="text">${obj.getRole()}</span> <!-- Engineer -->
        </div>
    </div>
    <div class="body">
        <ul>
            <li>ID: ${obj.getId()}</li>
            <li>Email: <a href="mailto:${obj.getEmail()}">${obj.getEmail()}</a></li>
            <li>Github: <a href="https://github.com/${obj.getGithub()}" target="_blank">${obj.getGithub()}</a></li>
        </ul>
    </div>
</li>`
    });
    data.interns.forEach(obj => {
        tmp += `
<li>
    <div class="head">
        <div class="name">${obj.getName()}</div>
        <div class="role">
            ...
            <span class="text">${obj.getRole()}</span> <!-- Intern -->
        </div>
    </div>
    <div class="body">
        <ul>
